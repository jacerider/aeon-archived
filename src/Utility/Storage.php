...
/**
 * @file
 * Contains \Drupal\aeon\Utility\Storage.
 */
 ...
 * @ingroup utility
 *
 * @see \Drupal\aeon\Utility\StorageItem
 */
class Storage extends MemoryStorage implements \Iterator {
   ...
   * {@inheritdoc}
   */
  public function __construct($cid, $bin = 'default', $expire = Cache::PERMANENT, $tags = [Aeon::CACHE_TAG]) {
