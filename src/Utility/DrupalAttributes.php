 ...
 * @ingroup utility
 *
 * @see \Drupal\aeon\Utility\Attributes
 * @see \Drupal\aeon\Utility\Element
 * @see \Drupal\aeon\Utility\Variables
 */
class DrupalAttributes extends ArrayObject {
   ...
   *
   * @var \Drupal\aeon\Utility\Attributes[]
   */
   ...
   * @return $this
   *
   * @see \Drupal\aeon\Utility\Attributes::addClass()
   */
   ...
   *
   * @see \Drupal\aeon\Utility\Attributes::getAttribute()
   */
   ...
   *   (optional) The type of attributes to use for this method.
   *
   * @return \Drupal\aeon\Utility\Attributes
   ...
   *
   * @see \Drupal\aeon\Utility\Attributes::getClasses()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\aeon\Utility\Attributes::hasAttribute()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\aeon\Utility\Attributes::hasClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\aeon\Utility\Attributes::removeAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\aeon\Utility\Attributes::removeClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\aeon\Utility\Attributes::replaceClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\aeon\Utility\Attributes::setAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\aeon\Utility\Attributes::setAttributes()
   */
