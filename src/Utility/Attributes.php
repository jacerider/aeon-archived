...
class Attributes extends ArrayObject {
   ...
   *
   * @see \Drupal\aeon\Utility\ArrayObject::offsetGet()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\aeon\Utility\ArrayObject::offsetExists()
   */
   ...
   *
   * @see \Drupal\aeon\Utility\ArrayObject::offsetUnset()
   */
   ...
   *
   * @see \Drupal\aeon\Utility\ArrayObject::offsetSet()
   */
   ...
   *
   * @see \Drupal\aeon\Utility\ArrayObject::merge()
   */
