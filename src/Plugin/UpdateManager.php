...
/**
 * Manages discovery and instantiation of Aeon updates.
 *
...
class UpdateManager extends PluginManager {
  ...
  /**
   * Constructs a new \Drupal\aeon\Plugin\UpdateManager object.
   *
  ...
  public function __construct(Theme $theme) {
    ...
    $this->pluginDefinitionAnnotationName = 'Drupal\aeon\Annotation\AeonUpdate';
    $this->pluginInterface = 'Drupal\aeon\Plugin\Update\UpdateInterface';
   ...
   *
   * @see \Drupal\aeon\Plugin\UpdateManager::getLatestSchema
   */
