...
namespace Drupal\aeon\Plugin\Setting;

use Drupal\aeon\Plugin\Form\FormInterface;
...
interface SettingInterface extends PluginInspectionInterface, FormInterface {
   ...
   *
   * @see \Drupal\aeon\Plugin\Setting\SettingBase::drupalSettings()
   *
   * @return bool
   *   TRUE or FALSE
   */
   ...
   *
   * @deprecated Will be removed in a future release. Use \Drupal\aeon\Plugin\Setting\SettingInterface::getGroupElement
   */
   ...
   *
   * @deprecated Will be removed in a future release. Use \Drupal\aeon\Plugin\Setting\SettingInterface::getSettingElement
   */
