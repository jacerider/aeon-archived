...
/**
 * Manages discovery and instantiation of Aeon theme settings.
 *
...
class SettingManager extends PluginManager {
  ...
  /**
   * Constructs a new \Drupal\aeon\Plugin\SettingManager object.
   *
   * @param \Drupal\aeon\Theme $theme
   *   The theme to use for discovery.
   */
  public function __construct(Theme $theme) {
    parent::__construct($theme, 'Plugin/Setting', 'Drupal\aeon\Plugin\Setting\SettingInterface', 'Drupal\aeon\Annotation\AeonSetting');
