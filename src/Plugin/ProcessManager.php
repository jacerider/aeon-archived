...
/**
 * Manages discovery and instantiation of Aeon form process callbacks.
 *
...
class ProcessManager extends PluginManager {
  ...
  /**
   * Constructs a new \Drupal\aeon\Plugin\ProcessManager object.
   *
   * @param \Drupal\aeon\Theme $theme
   *   The theme to use for discovery.
   */
  public function __construct(Theme $theme) {
    parent::__construct($theme, 'Plugin/Process', 'Drupal\aeon\Plugin\Process\ProcessInterface', 'Drupal\aeon\Annotation\AeonProcess');
  ...
  public static function process(array $element, FormStateInterface $form_state, array &$complete_form) {
    if (!empty($element['#aeon_ignore_process'])) {
      return $element;
    }
